...
$action = New-ScheduledTaskAction -Execute $windowsPowerShell -Argument "-NoLogo -NoProfile -NonInteractive -ExecutionPolicy Bypass -File `"$taskWrapper`"" -WorkingDirectory $runnerRoot
